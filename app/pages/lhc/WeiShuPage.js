...
const Layout = layout[13]
const objData = Layout
const groupTitle = Layout.totleTitle

class SeBoPage extends Component {
  ...
  _onPressConfirm() {
    ...
    sendAction.gameNum = 20 + this.state.activeTab
...
export default connect(mapStateToProps, mapDispatchToProps)(SeBoPage)
