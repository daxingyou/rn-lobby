...
const Layout = layout[14]
const objData = Layout
const groupTitle = Layout.totleTitle

class QiMaWuHangPage extends Component {
  constructor(props) {
    super(props)
    this.state = {
      betInput: '2',
  ...
  _onPressConfirm = () => {
    ...
    sendAction.name = layout[14].name
    sendAction.gameNum = 22
...
export default connect(mapStateToProps, mapDispatchToProps)(QiMaWuHangPage)
