...
import {
  View, StyleSheet, TouchableOpacity, Animated, Text, Image,
} from 'react-native'
...
export default class SettingDetailMainPage extends Component {
  ...
  _renderContent() {
    ...
    return (
      <SettingDetailList id={showLotteryId.selectedId || 1} token={token}/>
    )
  }
