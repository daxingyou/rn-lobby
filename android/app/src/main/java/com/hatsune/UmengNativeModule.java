...
public class UmengNativeModule extends ReactContextBaseJavaModule {
    ...
    public UmengNativeModule(ReactApplicationContext reactContext) {
        ...
        channelId = WalleChannelReader.getChannel(mContext);
    }
    ...
    public Map<String, Object> getConstants() {
        ...
        constants.put("channelId", channelId);
        constants.put("appKey", BuildConfig.UMENG_APPKEY);
        return constants;
    }
...
//        UMGameAgent.startWithConfigure(new UMGameAgent.UMAnalyticsConfig(mContext, BuildConfig.UMENG_APPKEY, mChannel));
